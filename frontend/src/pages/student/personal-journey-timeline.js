...
export function resolvePersonalJourneyFrame({
  ...
  return {
    ...
    background: {
      ...
      saturation: mixJourneyValue(0.72, 1.02, pull),
      brightness: mixJourneyValue(0.56, 0.82, pull),
      opacity: mixJourneyValue(0.68, 0.9, pull),
      nebulaScale: mixJourneyValue(1.2, 0.98, pull),
      nebulaXPercent: mixJourneyValue(-2, 1, pull),
      nebulaYPercent: mixJourneyValue(-2, 0, pull),
      nebulaOpacity: mixJourneyValue(0.16, 0.07, pull),
    },
    discovery: {
      intro,
