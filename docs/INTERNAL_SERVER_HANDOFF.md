...
> **D-109（2026-09-18，已发布）**：半屏控台、一屏核验与选色、94 个游客名额、正式轮次归档重置及统一舞台标题已实现。当前流程以[主控操作单](./LIVE_OPERATOR_GUIDE.md)、[主持对稿单](./HOST_CUE_GUIDE.md)、[实施验收](./D109_IMPLEMENTATION.md)和[发布恢复索引](./D109_RELEASE_AND_RECOVERY.md)为准。已部署 `20260918-d109-99bdde4fc401`，schema 23；原场次保持已结束、第 1 轮，未执行重置。下方版本通知仅为历史记录。

> **D-108（2026-09-17，已发布）**：当前 release 为 `20260917-d108-faf816d0cf47`。独立 schema 22 正式库，256 名学生＋50 个工作人员，初始 LIVE / READY、0 人入场；六类校园奖未确认、未揭晓。35 段主持动画已上线；D-107 和旧排练库保留。当前操作以[主持对稿单](./HOST_CUE_GUIDE.md)、[实施验收](./D108_IMPLEMENTATION.md)和[发布恢复索引](./D108_RELEASE_AND_RECOVERY.md)为准。恢复须同时切回旧代码与旧配置，保留新正式库；下方旧版本内容保留历史时点。
