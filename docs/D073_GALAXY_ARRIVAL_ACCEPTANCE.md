...
- 旧手机云雾框与程序化盘面叠加，形体模糊且像两层壁纸，退役其主背景用途。保留银河背景的叙事作用，改用 imagegen 原创的暖白核心、银蓝外盘与细密暗尘素材，作为唯一主盘面；星点、本人星号、轻微运镜和阶段动作独立绘制。原图 1536 × 1024，运行 WebP 169,312 bytes；原图、旧文件及 [生成提示词与来源](./archive/visual-assets/mobile/galaxy-cinematic-d073.md) 保留。
